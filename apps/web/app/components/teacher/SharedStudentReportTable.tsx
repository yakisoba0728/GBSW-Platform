...
type SharedStudentReportTableProps<Student extends SharedStudentMileageSummary> = {
  students: Student[]
  startDate: string
  endDate: string
...
function buildCategoryStats<Entry extends SharedMileageHistoryItem>(entries: Entry[]) {
...
function StudentDetailPanel<Entry extends SharedMileageHistoryItem>({
  studentId,
  startDate,
  endDate,
  entriesApiPath,
    ...
    return (
      ...
      >
        <EmptyStatePane
          ...
          description={error ? '잠시 후 다시 시도해 주세요.' : emptyDescription}
...
export default function SharedStudentReportTable<
  Student extends SharedStudentMileageSummary,
  Entry extends SharedMileageHistoryItem,
>({
  students,
  startDate,
  endDate,
