...
export default function DormMileageStudentView() {
  return (
    <SharedMileageStudentView<
      ...
      PaginatedDormMileageHistoryResponse
    >
      studentsPath="/api/teacher/dorm-mileage/students"
      summaryPath={(studentId) =>
        `/api/teacher/dorm-mileage/students/${encodeURIComponent(studentId)}/summary`
      }
      ...
      searchTitle="학생별 조회"
      searchSubtitle="학생을 검색하고 선택하면 누적 기숙사 상벌점 요약과 처리 내역을 확인할 수 있습니다."
