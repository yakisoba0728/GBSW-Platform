...
export default function DormStudentSelectionModal({
  ...
  }, [classNumber, grade, isOpen])

  function toggleStudent(student: DormMileageStudentOption) {
  ...
  return (
    <ModalBase isOpen={isOpen} onClose={handleClose} maxWidth="max-w-3xl">
      ...
      >
        ...
        <div
          className="grid grid-cols-2 gap-2 px-5 py-4 md:grid-cols-3"
          style={{ borderBottom: '1px solid var(--admin-border)' }}
        >
          <select
            value={grade}
