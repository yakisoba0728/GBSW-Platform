...
import { HomeIcon, ShieldCheckIcon, BuildingIcon } from '@/app/components/ui/icons'
...
export const TEACHER_NAV_ITEMS: DashboardNavItem[] = [
  ...
  },
  {
    ...
    children: [
      { href: '/teacher/dorm-mileage/grant', label: '상벌점 부여' },
      { href: '/teacher/dorm-mileage/history', label: '상벌점 내역' },
      { href: '/teacher/dorm-mileage/students', label: '학생별 조회' },
      { href: '/teacher/dorm-mileage/stats', label: '통계 보기' },
      { href: '/teacher/dorm-mileage/classes', label: '학급별 현황' },
      { href: '/teacher/dorm-mileage/rules', label: '상벌점 항목' },
      { href: '/teacher/dorm-mileage/report', label: '보고서 출력' },
    ],
  },
]
